define(['app/app', 'app/helper', 'text!../../templates/app/content.message.html', 'text!../../templates/app/footer.message.html'],
function (App, Helper, contentTmpl, footerTmpl){
	...
	App.Page_Message = (function(){
		...
		var _pageLayout = Helper.newPageLayout({
			...
			headerView: 	Helper.newHeaderView({name:_pageName, title:'Welcome to the Message Page'}),
